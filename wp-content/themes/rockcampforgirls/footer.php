...
<?php if ( !is_page_template('page-lyrics.php') ): ?>
<div id="footer" class="clearfix">
    ...
    <div id="footer-wrapper">
        ...
        <div class="grid col-940">
            <div id="footertext">
                <p>copyright © 2014 <a href="http://www.girlsrockmontreal.com/">Rock Camp For Girls Montréal</a>
                    </p>
    ...
    <?php endif; ?> <!-- end page-lyrics.php conditional -->
